...
The text file with song's info is created in C:\Users\[User]\Documents\SongInfo. Go to your OBS scene, add a text source, select read from file and pick the generated file.
